...
class Timer extends Component {
  ...
  stopTimer() {
    ...
    let Time = this.pad(Math.floor(this.state.time / 60000), 2) + ":" + this.pad((Math.floor(this.state.time / 1000) % 60), 2) + ":" + this.pad((this.state.time % 1000), 3)
    this.props.handlerFromP(Time)
  }
